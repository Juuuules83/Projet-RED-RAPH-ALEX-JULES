...
func Lore(name string) {
	...
	fmt.Println(utils.Magenta + utils.Bold + "╔══════════════════════════════════════════════════════════════════════╗")
	...
	fmt.Println()
	dialogueLore(fmt.Sprintf(utils.Cyan + utils.Bold + "Vito - " + utils.Reset + " %s, nous avons besoin de toi pour atteindre le noyau Ytrack.", name))
	fmt.Println()
	...
	fmt.Println()
	dialogueLore(fmt.Sprintf(utils.Cyan + utils.Bold + "Vito - " + utils.Reset + " %s, ta spécialisation sera ta première arme. Choisis celle qui correspond à ta façon de résoudre les problèmes.", name))


// Attend que le joueur appuie sur Entrée avant de choisir sa classe
